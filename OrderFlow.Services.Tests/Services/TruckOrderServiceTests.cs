namespace OrderFlow.Tests.Services
{
    ...
    public class TruckOrderServiceTests
    {
        ...
        //private CourseOrderService _truckOrderService;
        ...
        //    _truckOrderService = new CourseOrderService(
        //      _context,
        ...
        //{
        //    _context.TrucksOrders.Add(new CourseOrder { TruckOrderID = Guid.NewGuid(), TruckID = Guid.NewGuid(), OrderID = Guid.NewGuid(), Status = CourseStatus.Assigned });
        //    _context.TrucksOrders.Add(new CourseOrder { TruckOrderID = Guid.NewGuid(), TruckID = Guid.NewGuid(), OrderID = Guid.NewGuid(), Status = CourseStatus.Delivered });
        ...
        //    Assert.IsTrue(_context.TrucksOrders.Any(to => to.OrderID == orderId1 && to.TruckID == truckId && to.Status == CourseStatus.Assigned));
        //    Assert.IsTrue(_context.TrucksOrders.Any(to => to.OrderID == orderId2 && to.TruckID == truckId && to.Status == CourseStatus.Assigned));
        ...
        //    _context.TrucksOrders.Add(new CourseOrder { TruckOrderID = Guid.NewGuid(), OrderID = orderId1, TruckID = truckId, DeliverAddress = "Address 1", Status = CourseStatus.Assigned });
        ...
        //    _context.TrucksOrders.Add(new CourseOrder
        //    {
        ...
        //    Assert.IsFalse(_context.TrucksOrders.Any(to => to.OrderID == orderId && to.TruckID == truckId && to.Status == CourseStatus.Assigned));
        ...
        //    Assert.IsFalse(_context.TrucksOrders.Any(to => to.OrderID == orderIdToRemove && to.TruckID == truckId && to.Status == CourseStatus.Assigned));
        //    Assert.IsTrue(_context.TrucksOrders.Any(to => to.OrderID == otherOrderId && to.TruckID == truckId && to.Status == CourseStatus.Assigned));
        ...
        //    Assert.That(completedOrder.Status, Is.EqualTo(CourseStatus.Delivered));
        ...
        //    Assert.AreEqual(CourseStatus.Delivered, order.Status);
        //    _mockNotificationService.Verify(s => s.AddAsync(It.IsAny<Notification>()), Times.Never);
        //}
